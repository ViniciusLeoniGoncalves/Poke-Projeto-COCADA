...
- Também veja o resultado do [projeto final da disciplina de Algebra Linear Algorítmica](https://github.com/ViniciusLeoniGoncalves/Poke-Projeto-ALA), a base temática utilizada para a construção deste trabalho.
